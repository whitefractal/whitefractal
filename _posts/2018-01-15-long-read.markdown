...
Following the [Dynamic Spectrum Alliance](http://dynamicspectrumalliance.org/)’s publication of its new Model Rules for TV White Spaces (TVWS), we published a blog **ADD LINK** giving an overview of the rules and their importance to the global development of TVWS. This second article is a deep-dive into some of the more detailed aspects of the rules, and how they have been crafted to achieve various real-world outcomes.
